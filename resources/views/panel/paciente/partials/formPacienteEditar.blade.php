    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="width: 90%; float: left;">Edición del Paciente</h4>
            ...
            <div class="modal-body">
                ...
                {{-- PARA VISUALIZAR LOS ACOMPANANTES DEL PACIENTE --}}
                <br><br>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <table class="data-table table table-bordered table-hover">
                            ...
                            <tbody id="acompanantesContent">
                                {{-- Aca se generan dinamicamente los acompanantes --}}
                            </tbody>
                        </table>
                    </div>
                </div>
