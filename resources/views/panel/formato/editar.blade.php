@extends('layouts.master')
	...
	@section('titulo','Edición de formato')

	@section('css')
    @endsection

	@section('contenido')
        <h2>Edición de Formato</h2>

        {!! Form::open(['route' => ['panel.formato.editar', $formato->id], 'method' => 'put']) !!}
		    {{ csrf_field() }}

        	@include('panel.formato.partials.formFormatoEditar')
        	<br><br>
