    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 style="width: 90%; float: left;">Registro de Nuevo Tratamiento</h4>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('concentracion', Input::old('concentracion'), ['class' => 'form-control', 'placeholder' => 'Ej: 50 mg/30 ml']) !!}
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label("unidades", 'Unidades por presentación') !!}
                            {!! Form::number('unidades', Input::old('unidades'), ['class' => 'form-control', 'placeholder' => 'Unidades por presentación', 'min' => 1, 'onkeypress' => 'return event.charCode >= 48']) !!}
                        </div>
                    </div>
                </div>
