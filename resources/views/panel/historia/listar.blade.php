@extends('layouts.master')
	...
	@section('titulo','Listado de historias clínicas')
		  	...
		  	<div class="col-md-4">
		  		@if(in_array(2, $permisos))
			        <div class="navbar-form pull-left">
		                <a class="btn btn-primary" href="{{ route('panel.historia.crear') }}" role="button">Crear Historia</a>
		                <br><br>
		            </div>
		        @endif
		  	</div>
	...
	@section('js')
            ...
            table = $("#manageMemberTable").DataTable({
                ...
                "columnDefs": [{
                    ...
                    "render": function (data, type, row) {
                        return '<a title="Editar" class="btn btn-warning" href="/panel/historia/detallar/' + data + '"><i class="fa fa-eye" style="display:table;margin:0 auto" aria-hidden="true"></i></a>';
                    }
                }],
                'language': {
        ...
        {!!Html::script('js/personal/historias.js')!!}
    @endsection