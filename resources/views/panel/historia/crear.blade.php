@extends('layouts.master')
	...
	@section('titulo','Creación de historia clínica')
	...
	@section('contenido')
	    <h2>Creación de Historia Clínica</h2>

    	@include('panel.historia.partials.formHistoriaCrear')

    	{{-- botones para agregar registros adicionales (consentimientos, incapacidades...) --}}
    	<h3 style="color: #24b4b5;">Registros Adicionales</h3>
        <p>Sólo los registros que estén abiertos/visibles al enviar los datos de la historia, serán los que se registrarán con la misma.</p>
        <br><br>
    	{{-- FORMULA MEDICA --}}
