@extends('layouts.master')
	...
	@section('titulo','Creación de sesión de tratamiento')
	...
	@section('contenido')
	    <h2>Creación de Sesión de Tratamiento</h2>

    	@include('panel.sesion.partials.formSesionCrear')

    	{{-- botones para agregar registros adicionales (consentimientos, incapacidades...) --}}
    	<h3 style="color: #24b4b5;">Registros Adicionales</h3>
        <p>Sólo los registros que estén abiertos/visibles al enviar los datos de la sesión, serán los que se registrarán con la misma.</p>
        <br><br>
    	{{-- FORMULA MEDICA --}}
