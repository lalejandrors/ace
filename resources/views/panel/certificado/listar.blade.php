@extends('layouts.master')
	...
	@section('titulo','Listado de certificados')
	...
	@section('js')
        ...
        <script>
            ...
            table = $("#manageMemberTable").DataTable({
                ...
                'filter': true,
                'ajax': {
                    "url": "/panel/certificado/datatable",
                    "type": "POST",
                    'headers': {
                        'X-CSRF-TOKEN': token
                    }
                ...
                "columnDefs": [{
                    ...
                    "render": function (data, type, row) {
                        return '<a title="Editar" class="btn btn-warning" href="/panel/certificado/ver/' + data + '" target="_blank"><i class="fa fa-eye" style="display:table;margin:0 auto" aria-hidden="true"></i></a>';
                    }
                }],
                'language': {
