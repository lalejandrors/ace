<!DOCTYPE html>
  <head>
    <meta charset="utf-8">
    <title>Certificado Médico Impresión</title>
  ...
  <body>
    ...
    <div id="contenido">
        ...
        {{-- TERMINA CABECERA --}}
        {{-- COMIENZA INFO GENERAL DEL CERTIFICADO --}}
        <table class="table table-bordered table-striped" >
          <tbody>
            <tr>
              <th><b>Número: </b></th>
        ...
        {{-- TERMINA INFO GENERAL DEL CERTIFICADO --}}
        {{-- COMIENZA PACIENTE --}}
        <table class="table table-bordered table-striped" >
          <thead>
            <tr>
        ...
        <table class="table table-bordered table-striped" >
          ...
          <tr>
            <th><b>Contenido: </b></th>
            <td colspan="5"><div style="margin: 20px;">{!! $certificado->contenido !!}</div></td>
          </tr>
          </tbody>
        </table>
