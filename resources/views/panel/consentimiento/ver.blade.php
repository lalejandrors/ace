<!DOCTYPE html>
  <head>
    <meta charset="utf-8">
    <title>Consentimiento Informado Impresión</title>
  ...
  <body>
    ...
    <div id="contenido">
        ...
        {{-- TERMINA CABECERA --}}
        {{-- COMIENZA INFO GENERAL DEL CONSENTIMIENTO --}}
        <table class="table table-bordered table-striped" >
          <tbody>
            <tr>
              <th><b>Número: </b></th>
              <td>{{ $consentimiento->numero }}</td>
              <th><b>Observación General: </b></th>
              <td>{{ $consentimiento->observacion }}</td>
              <th><b>Fecha de Creación: </b></th>
              <td>{{ $consentimiento->created_at }}</td>
            </tr>
          </tbody>
        </table>
        {{-- TERMINA INFO GENERAL DEL CONSENTIMIENTO --}}
        {{-- COMIENZA PACIENTE --}}
        <table class="table table-bordered table-striped" >
          <thead>
            <tr>
        ...
        <table class="table table-bordered table-striped" >
          ...
          <tr>
            <th><b>Contenido: </b></th>
            <td colspan="5"><div style="margin: 20px;">{!! $consentimiento->contenido !!}</div></td>
          </tr>
          </tbody>
        </table>
