...
table = $("#manageMemberTable").DataTable({
    ...
    'filter': true,
    'ajax': {
        "url": "/panel/laboratorio/datatable",
        "type": "POST",
        'headers': {
            'X-CSRF-TOKEN': token
        }
...
$("#registro").click(function(){
    ...
    var route = "/panel/laboratorio/almacenar"; 
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data.mensaje == "Ok"){
                swal({
                  title: 'Laboratorio Creado Correctamente',
                  type: 'success',
                },
                function(isConfirm){
                  if(isConfirm){
...
function editMember(id) {
    ...
    var route = "/panel/laboratorio/edicion/"+id;
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $("#responsive-modal-edit #laboratorioId").val(data.id);
...
$("#edicion").click(function(){
    ...
    var token = $("#responsive-modal-edit #token").val();
    var laboratorio = $("#laboratorioId").val();

    var nombre = $("#responsive-modal-edit #nombre").val();

    var route = "/panel/laboratorio/editar/"+laboratorio;
...
function deleteMember(id) {
    ...
    function(isConfirm){
        if(isConfirm){
            ...
            var route = "/panel/laboratorio/eliminar"; 
