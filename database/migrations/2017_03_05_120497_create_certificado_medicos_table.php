...
class CreateCertificadoMedicosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('certificado_medicos', function (Blueprint $table) {
            $table->increments('id');
            $table->string('numero');
    ...
    {
        Schema::dropIfExists('certificado_medicos');
    }
}
